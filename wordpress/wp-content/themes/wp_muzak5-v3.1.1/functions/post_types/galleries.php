...
function galleries_save_meta( $post_id, $post ) {
	...
	update_post_meta($post->ID, 'ci_cpt_galleries_venue', sanitize_text_field($_POST['ci_cpt_galleries_venue']) );
	update_post_meta($post->ID, 'ci_cpt_galleries_location', sanitize_text_field($_POST['ci_cpt_galleries_location']) );
	update_post_meta($post->ID, 'ci_cpt_galleries_caption', ci_sanitize_checkbox($_POST['ci_cpt_galleries_caption'], 1) );
