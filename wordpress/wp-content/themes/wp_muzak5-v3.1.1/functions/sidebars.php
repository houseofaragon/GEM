...
function ci_widgets_init() {
	...
	register_sidebar(array(
		...
		'id' => 'blog-sidebar',
		'description' => __( 'Place here the widgets that you want to display on your blog sidebar', 'ci_theme'),
		'before_widget' => '<div id="%1$s" class="%2$s widget group">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>'
	...
	if ( woocommerce_enabled() ) {
		register_sidebar(array(
			'name' => __( 'Shop Sidebar', 'ci_theme'),
			'id' => 'shop-sidebar',
			'description' => __( 'Place here the widgets that you want to display on your shop sidebar', 'ci_theme'),
			'before_widget' => '<div id="%1$s" class="%2$s widget group">',
			'after_widget' => '</div>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
